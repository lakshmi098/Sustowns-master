...
// billing
    ...
    public void setParameter() {
        ...
        mPaymentParams.setFirstName(preferenceUtils.getStringFromPreference(PreferenceUtils.FULL_NAME, "Sustowns"));

        mPaymentParams.setEmail(preferenceUtils.getStringFromPreference(PreferenceUtils.USER_EMAIL, "customer@gmail.com"));
        ...
        mPaymentParams.setTxnId(preferenceUtils.getStringFromPreference(PreferenceUtils.ORDER_ID, ""));
        /**
    ...
    public void generateHashFromSDK(PaymentParams mPaymentParams, String salt) {
        ...
        // for getting Pay Bank code
        mPaymentParams.getBankCode();
    ...
    public void setPayUSuccess() {
        String bankCode = mPaymentParams.getBankCode();
        String transactionId = mPaymentParams.getTxnId();
        String pg = mPaymentParams.getPg();
        try {
            JSONObject jsonObj = new JSONObject();
            jsonObj.put("userid", user_id);
            jsonObj.put("txnid","98475685");
            jsonObj.put("orderid",PayUorderid);
            jsonObj.put("amount",totalAmount);
            jsonObj.put("mode","NB");
            jsonObj.put("mihpayid","9260971723");
            ...
            jsonObj.put("PG_TYPE","SBINB");
            jsonObj.put("bank_ref_num","IGAGUWTGO2");
            jsonObj.put("bankcode","SBIB");
    ...
    public void setPayUFailure() {
        try {
            JSONObject jsonObj = new JSONObject();
            jsonObj.put("userid", user_id);
            jsonObj.put("txnid",mPaymentParams.getTxnId());
            jsonObj.put("orderid",PayUorderid);
            jsonObj.put("amount",totalAmount);
            jsonObj.put("mode","");
